$(document).ready(function() {
    ...
    var renderMessage = function(messge) {
        var gameMessageSet = $('#game-messge');
        ...
        if ($('#defender').children().length !== 0) {
            ...
            if (defender.health > 0) {
                ...
                var gameSateMessage =
                    'You have defeated ' +
                    defender.name +
                    ', you can choose to fight another enemy, should you dare!';
                renderMessage(gameSateMessage);
                killCount++;
